---
title: 日推歌单 Vol.40｜TODO：歌名填充
date: 2026-05-09 08:00:00 +0800
categories: [Music]
tags: [日推歌单, 动漫音乐, ACG]
---

<!-- slug: daily-songlist-待补 -->
...
<ul id="daily-playlist" style="list-style:none; padding-left:0; margin:0;">
    <li style="display:flex; align-items:center; gap:12px; margin:10px 0;">
        <button class="song-play" data-src="/assets/media/daily-songlist-40.mp3" data-title="示例曲目 — 待补" type="button" aria-label="播放 示例曲目" title="播放">▶</button>
        <span>示例曲目 — 待补</span>
    </li>
</ul>
...
<div style="margin-top: 14px;">
    <audio id="daily-player" controls preload="metadata" style="width:100%;">
        <source src="TODO:替换成本地真实文件：/assets/media/daily-songlist-40.mp3" type="audio/mpeg">
        你的浏览器不支持 audio 标签
    </audio>
    <p id="now-playing" style="margin:8px 0 0; color:#9aa0a6;">Now Playing: 示例曲目 — 待补</p>
</div>

<details style="margin-top:14px;">
    <summary>查看歌词文件（LRC）</summary>
    <p><a href="TODO:替换成本地真实文件：/assets/lyrics/daily-songlist-40.lrc" target="_blank" rel="noopener">打开 LRC 歌词</a></p>
</details>

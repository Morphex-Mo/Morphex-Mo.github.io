---
title: 日推歌单 Vol.124｜Hacking to the Gate (symphonic ver.)
date: 2026-08-01 08:00:00 +0800
categories: [Music]
tags: [日推歌单, 动漫音乐, ACG]
---

<!-- slug: daily-songlist-124 -->

今天推荐伊藤加奈子《Hacking to the Gate (symphonic ver.)》。原曲的命运感在交响化后变得更宏大，旋律像一次次穿越世界线的决意；听着会想起《命运石之门》里那种明知痛苦也要抵达真相的执念。
...
<ul id="daily-playlist" style="list-style:none; padding-left:0; margin:0;">
    <li style="display:flex; align-items:center; gap:12px; margin:10px 0;">
        <button class="song-play" data-src="/assets/media/KanakoIto-HackingToTheGate.mp3" data-title="Hacking to the Gate (symphonic ver.)（伊藤加奈子）" type="button" aria-label="播放 Hacking to the Gate" title="播放">▶</button>
        <span>Hacking to the Gate (symphonic ver.)（伊藤加奈子）</span>
    </li>
</ul>

<div style="margin-top: 14px;">
    <audio id="daily-player" controls preload="metadata" style="width:100%;">
        <source src="/assets/media/KanakoIto-HackingToTheGate.mp3" type="audio/mpeg">
        你的浏览器不支持 audio 标签
    </audio>
    <p id="now-playing" style="margin:8px 0 0; color:#9aa0a6;">Now Playing: Hacking to the Gate (symphonic ver.)（伊藤加奈子）</p>
</div>

<details style="margin-top:14px;">
    <summary>查看歌词文件（LRC）</summary>
    <p><a href="/assets/lyrics/KanakoIto-HackingToTheGate.lrc" target="_blank" rel="noopener">打开 LRC 歌词</a></p>
</details>
...
<div id="lrc-panel" data-lrc="/assets/lyrics/KanakoIto-HackingToTheGate.lrc">

---
title: 日推歌单 Vol.90｜only my railgun
date: 2026-06-28 08:00:00 +0800
categories: [Music]
tags: [日推歌单, 动漫音乐, ACG]
---

<!-- slug: daily-songlist-90 -->

今天推荐 fripSide《only my railgun》（《某科学的超电磁炮》OP）。这首歌一开场就把电光般的速度感拉满，合成器和南條爱乃清亮的声线一路向前冲；副歌像把“只相信自己的道路”唱成宣言，燃得很直接。
...
<ul id="daily-playlist" style="list-style:none; padding-left:0; margin:0;">
    <li style="display:flex; align-items:center; gap:12px; margin:10px 0;">
        <button class="song-play" data-src="/assets/media/fripSide-OnlyMyRailgun.mp3" data-title="only my railgun（fripSide）" type="button" aria-label="播放 only my railgun" title="播放">▶</button>
        <span>only my railgun（fripSide）</span>
    </li>
</ul>

<div style="margin-top: 14px;">
    <audio id="daily-player" controls preload="metadata" style="width:100%;">
        <source src="/assets/media/fripSide-OnlyMyRailgun.mp3" type="audio/mpeg">
        你的浏览器不支持 audio 标签
    </audio>
    <p id="now-playing" style="margin:8px 0 0; color:#9aa0a6;">Now Playing: only my railgun（fripSide）</p>
</div>

<details style="margin-top:14px;">
    <summary>查看歌词文件（LRC）</summary>
    <p><a href="/assets/lyrics/fripSide-OnlyMyRailgun.lrc" target="_blank" rel="noopener">打开 LRC 歌词</a></p>
</details>
...
<div id="lrc-panel" data-lrc="/assets/lyrics/fripSide-OnlyMyRailgun.lrc">

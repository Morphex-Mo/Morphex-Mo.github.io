---
title: 日推歌单 Vol.129｜NOX LUX
date: 2026-08-06 08:00:00 +0800
categories: [Music]
tags: [日推歌单, 动漫音乐, ACG]
---

<!-- slug: daily-songlist-129 -->

今天推荐 MYTH & ROID《NOX LUX》。黑暗感和电子编曲是他们很拿手的领域，这首歌也有一种夜色里燃起光的紧张感；节奏沉着推进，越听越像走进异世界深处。
...
<ul id="daily-playlist" style="list-style:none; padding-left:0; margin:0;">
    <li style="display:flex; align-items:center; gap:12px; margin:10px 0;">
        <button class="song-play" data-src="/assets/media/MythRoid-NoxLux.mp3" data-title="NOX LUX（MYTH &amp; ROID）" type="button" aria-label="播放 NOX LUX" title="播放">▶</button>
        <span>NOX LUX（MYTH &amp; ROID）</span>
    </li>
</ul>

<div style="margin-top: 14px;">
    <audio id="daily-player" controls preload="metadata" style="width:100%;">
        <source src="/assets/media/MythRoid-NoxLux.mp3" type="audio/mpeg">
        你的浏览器不支持 audio 标签
    </audio>
    <p id="now-playing" style="margin:8px 0 0; color:#9aa0a6;">Now Playing: NOX LUX（MYTH &amp; ROID）</p>
</div>

<details style="margin-top:14px;">
    <summary>查看歌词文件（LRC）</summary>
    <p><a href="/assets/lyrics/MythRoid-NoxLux.lrc" target="_blank" rel="noopener">打开 LRC 歌词</a></p>
</details>
...
<div id="lrc-panel" data-lrc="/assets/lyrics/MythRoid-NoxLux.lrc">

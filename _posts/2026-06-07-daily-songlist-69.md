---
title: 日推歌单 Vol.69｜ReawakeR
date: 2026-06-07 08:00:00 +0800
categories: [Music]
tags: [日推歌单, 动漫音乐, ACG]
---

<!-- slug: daily-songlist-69 -->

今天推荐 LiSA / Felix《ReawakeR》（《我独自升级 第二季》OP）。这首歌有很典型的澤野弘之式爆发力，LiSA 的声线和 Felix 的段落把压迫感、反击感都拉满，像从低谷里重新睁眼，带着复仇和觉醒一路冲出去。
...
<ul id="daily-playlist" style="list-style:none; padding-left:0; margin:0;">
    <li style="display:flex; align-items:center; gap:12px; margin:10px 0;">
        <button class="song-play" data-src="/assets/media/LisaFelix-ReawakeR.mp3" data-title="ReawakeR（LiSA / Felix）" type="button" aria-label="播放 ReawakeR" title="播放">▶</button>
        <span>ReawakeR（LiSA / Felix）</span>
    </li>
</ul>

<div style="margin-top: 14px;">
    <audio id="daily-player" controls preload="metadata" style="width:100%;">
        <source src="/assets/media/LisaFelix-ReawakeR.mp3" type="audio/mpeg">
        你的浏览器不支持 audio 标签
    </audio>
    <p id="now-playing" style="margin:8px 0 0; color:#9aa0a6;">Now Playing: ReawakeR（LiSA / Felix）</p>
</div>

<details style="margin-top:14px;">
    <summary>查看歌词文件（LRC）</summary>
    <p><a href="/assets/lyrics/LisaFelix-ReawakeR.lrc" target="_blank" rel="noopener">打开 LRC 歌词</a></p>
</details>
...
<div id="lrc-panel" data-lrc="/assets/lyrics/LisaFelix-ReawakeR.lrc">

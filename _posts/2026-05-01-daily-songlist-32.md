---
title: 日推歌单 Vol.32｜转动命运之轮 — 坂井泉水（ZARD）
date: 2026-05-01 08:00:00 +0800
categories: [Music]
tags: [日推歌单, 动漫音乐, ACG]
---

<!-- 依据 MAINTENANCE_DAILY_SONGLIST.md 规范，slug: turning-fate -->

今天的日推是一首具有怀旧与力量感的曲目《转动命运之轮》，原唱 / 演绎为坂井泉水（ZARD）。这首歌的旋律与歌词常带有治愈与希望的力量，适合在需要一些慰藉或回味时播放。
...
<ul id="daily-playlist" style="list-style:none; padding-left:0; margin:0;">
	<li style="display:flex; align-items:center; gap:12px; margin:10px 0;">
		<button class="song-play" data-src="/assets/media/turning-fate.mp3" data-title="转动命运之轮 — 坂井泉水" type="button" aria-label="播放 转动命运之轮" title="播放">▶</button>
		<span>转动命运之轮 — 坂井泉水</span>
	</li>
</ul>

<div style="margin-top: 14px;">
	<audio id="daily-player" controls preload="metadata" style="width:100%;">
		<source src="/assets/media/turning-fate.mp3" type="audio/mpeg">
		你的浏览器不支持 audio 标签
	</audio>
	<p id="now-playing" style="margin:8px 0 0; color:#9aa0a6;">Now Playing: 转动命运之轮 — 坂井泉水</p>
</div>

<details style="margin-top:14px;">
	<summary>查看歌词文件（LRC）</summary>
	<p><a href="/assets/lyrics/turning-fate.lrc" target="_blank" rel="noopener">打开 LRC 歌词</a></p>
</details>
...
<div id="lrc-panel" data-lrc="/assets/lyrics/turning-fate.lrc">

---
title: 日推歌单 Vol.121｜スパークル (Movie ver.)
date: 2026-07-29 08:00:00 +0800
categories: [Music]
tags: [日推歌单, 动漫音乐, ACG]
---

<!-- slug: daily-songlist-121 -->

今天推荐 RADWIMPS《スパークル (Movie ver.)》（《你的名字。》插曲）。这首歌像时间忽然慢下来，钢琴和弦乐把命运感一层层铺开；等情绪爆发时，所有奔跑和寻找都变得格外动人。
...
<ul id="daily-playlist" style="list-style:none; padding-left:0; margin:0;">
    <li style="display:flex; align-items:center; gap:12px; margin:10px 0;">
        <button class="song-play" data-src="/assets/media/RADWIMPS-SparkleMovieVer.mp3" data-title="スパークル (Movie ver.)（RADWIMPS）" type="button" aria-label="播放 スパークル" title="播放">▶</button>
        <span>スパークル (Movie ver.)（RADWIMPS）</span>
    </li>
</ul>

<div style="margin-top: 14px;">
    <audio id="daily-player" controls preload="metadata" style="width:100%;">
        <source src="/assets/media/RADWIMPS-SparkleMovieVer.mp3" type="audio/mpeg">
        你的浏览器不支持 audio 标签
    </audio>
    <p id="now-playing" style="margin:8px 0 0; color:#9aa0a6;">Now Playing: スパークル (Movie ver.)（RADWIMPS）</p>
</div>

<details style="margin-top:14px;">
    <summary>查看歌词文件（LRC）</summary>
    <p><a href="/assets/lyrics/RADWIMPS-SparkleMovieVer.lrc" target="_blank" rel="noopener">打开 LRC 歌词</a></p>
</details>
...
<div id="lrc-panel" data-lrc="/assets/lyrics/RADWIMPS-SparkleMovieVer.lrc">

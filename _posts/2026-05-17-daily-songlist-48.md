---
title: 日推歌单 Vol.48｜secret base ～君がくれたもの～
date: 2026-05-17 08:00:00 +0800
categories: [Music]
tags: [日推歌单, 动漫音乐, ACG]
---

<!-- slug: daily-songlist-48 -->

今天推荐《secret base ～君がくれたもの～》（《未闻花名》主题曲）。这是一首温柔而带着淡淡哀愁的治愈系曲目，旋律与合声极具穿透力，适合在想念或回忆时静静聆听。
...
<ul id="daily-playlist" style="list-style:none; padding-left:0; margin:0;">
    <li style="display:flex; align-items:center; gap:12px; margin:10px 0;">
        <button class="song-play" data-src="/assets/media/SecretBase-Anohana.mp3" data-title="secret base ～君がくれたもの～" type="button" aria-label="播放 secret base" title="播放">▶</button>
        <span>secret base ～君がくれたもの～（未闻花名 主题曲）</span>
    </li>
</ul>

<div style="margin-top: 14px;">
    <audio id="daily-player" controls preload="metadata" style="width:100%;">
        <source src="/assets/media/SecretBase-Anohana.mp3" type="audio/mpeg">
        你的浏览器不支持 audio 标签
    </audio>
    <p id="now-playing" style="margin:8px 0 0; color:#9aa0a6;">Now Playing: secret base ～君がくれたもの～（未闻花名）</p>
</div>

<details style="margin-top:14px;">
    <summary>查看歌词文件（LRC）</summary>
    <p><a href="/assets/lyrics/SecretBase-Anohana.lrc" target="_blank" rel="noopener">打开 LRC 歌词</a></p>
</details>
...
<div id="lrc-panel" data-lrc="/assets/lyrics/SecretBase-Anohana.lrc">

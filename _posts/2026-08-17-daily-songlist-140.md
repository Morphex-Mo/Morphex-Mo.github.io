---
title: 日推歌单 Vol.140｜ハートの確率
date: 2026-08-17 08:00:00 +0800
categories: [Music]
tags: [日推歌单, 动漫音乐, ACG]
---

<!-- slug: daily-songlist-140 -->

今天推荐 blue drops《ハートの確率》。这首歌有老派动画 OP 的明亮感，旋律甜而不腻，副歌很容易跟着哼；像把恋爱里的偶然和命中注定都唱成了轻快的心跳。
...
<ul id="daily-playlist" style="list-style:none; padding-left:0; margin:0;">
    <li style="display:flex; align-items:center; gap:12px; margin:10px 0;">
        <button class="song-play" data-src="/assets/media/BlueDrops-HeartNoKakuritsu.mp3" data-title="ハートの確率（blue drops）" type="button" aria-label="播放 ハートの確率" title="播放">▶</button>
        <span>ハートの確率（blue drops）</span>
    </li>
</ul>

<div style="margin-top: 14px;">
    <audio id="daily-player" controls preload="metadata" style="width:100%;">
        <source src="/assets/media/BlueDrops-HeartNoKakuritsu.mp3" type="audio/mpeg">
        你的浏览器不支持 audio 标签
    </audio>
    <p id="now-playing" style="margin:8px 0 0; color:#9aa0a6;">Now Playing: ハートの確率（blue drops）</p>
</div>

<details style="margin-top:14px;">
    <summary>查看歌词文件（LRC）</summary>
    <p><a href="/assets/lyrics/BlueDrops-HeartNoKakuritsu.lrc" target="_blank" rel="noopener">打开 LRC 歌词</a></p>
</details>
...
<div id="lrc-panel" data-lrc="/assets/lyrics/BlueDrops-HeartNoKakuritsu.lrc">
